...
public class MeasuredFirstChild {
	...
	private List<MeasuredSecondChild> child;
	...
	public List<MeasuredSecondChild> getChild() {
		return child;
	}
	public void setChild(List<MeasuredSecondChild> child) {
		this.child = child;
	}
