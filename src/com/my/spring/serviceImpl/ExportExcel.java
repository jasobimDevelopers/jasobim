...
public class ExportExcel {  
    ...
    public void createNormalHead(String headString, int colSum) {  
        ...
        HSSFCell cell = row.createCell(0);  // 设置第一列
     ...
     *            标题字符串数组 
     */  
    public void createColumHeader(String[] columHeader) {  ////表头th
    ...
    public void cteateCell(HSSFWorkbook wb, HSSFRow row, int col, short align,  
            String val) {  
        HSSFCell cell = row.createCell(col);  ///创建多少列
        cell.setCellType(HSSFCell.ENCODING_UTF_16);  
        cell.setCellValue(new HSSFRichTextString(val));  ///填充每一列的值
        HSSFCellStyle cellstyle = wb.createCellStyle();  
