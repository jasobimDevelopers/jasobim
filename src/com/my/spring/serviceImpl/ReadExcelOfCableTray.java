...
public class ReadExcelOfCableTray {
    //总行数
   ...
   * @return
   */
  public List<CableTray> getExcelInfo(String fileName,MultipartFile Mfile,Long projectId){
      ...
      //把spring文件上传的MultipartFile转换成CommonsMultipartFile类型
       ...
       //初始化客户信息的集合    
       List<CableTray> elementList=new ArrayList<CableTray>();
       //初始化输入流
       InputStream is = null;  
       try{
          //验证文件名是否合格
   ...
   * @throws IOException
   */
  public  List<CableTray> getExcelInfo(InputStream is,boolean isExcel2003,Long projectId){
       List<CableTray> elementList=null;
       try{
           /** 根据版本选择创建Workbook的方式 */
           Workbook wb = null;
           //当excel是2003时
...
private List<CableTray> readExcelValue(Workbook wb,Long projectId){ 
      //得到第一个shell  
