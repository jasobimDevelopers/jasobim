function qualityInfoController($scope, $sce,qualityInfoService) {
		  ...
		  questionInfoService.getQuestionInfoDetail(id).then(function (result){
		  	...
		  	if($scope.questionInfo!=null){
		  		...
		  		$scope.getMessageByQuestionId();
		  		 ...
		  		 questionInfoService.getQualityInfoDetail(id).then(function (result){
		 		  	$scope.questionInfo = result.data;
		 		  	if($scope.questionInfo!=null){
		 		  		if($scope.questionInfo.fileList!=null){
		 		  			var test=$scope.questionInfo.fileList;
    ...
    $scope.getQualityInfoDetail = function(id) {
		  questionInfoService.getQualityInfoDetail(id).then(function (result){
		  	$scope.questionInfo = result.data;
		  	if($scope.questionInfo!=null){
		  		if($scope.questionInfo.fileList!=null){
    ...
    $scope.getMessageByQualityId = function() {
		  questionInfoService.getMessageByqualityId($scope.questionId).then(function (result){
		  	  $scope.messageListInfo = result.data;
		  	if($scope.messageListInfo!=""){
		  		for(var g=0;g<$scope.messageListInfo.length;g++){
					$scope.messageList=[];
